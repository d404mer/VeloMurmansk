...
const REGIONS = [
  ...
  { name: 'Республика Алтай', code: 'АЛТ', file: 'Республика Алтай.jpg', aliases: [] },
  ...
  { name: 'Республика Мордовия', code: 'МОР', file: 'Республика Мордовия.jpg', aliases: ['мордовия'] },
  {
    ...
    aliases: ['республика саха якутия', 'республика саха', 'якутия'],
  },
  {
  ...
  { name: 'Алтайский край', code: 'АЛТ', file: 'Алтайский Край.jpg', aliases: ['алтайский край'] },
  ...
  { name: 'Сахалинская область', code: 'САХ', file: 'Сахалинская область.jpg', aliases: ['сахалинская область', 'сахалин'] },
  ...
  { name: 'Челябинская область', code: 'ЧЕЛ', file: 'Челябинская область.jpg', aliases: ['челябинская область', 'челябинск'] },
...
function resolveRegion(text) {
  ...
  if (normalized.length >= 5) {
    for (const { alias, region } of phrases) {
      if (includesPhrase(alias, normalized)) return withFlag(region);
    }
  }
