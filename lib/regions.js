...
const REGIONS = [
  ...
  { name: 'Челябинская область', code: 'ЧЛБ', altCodes: ['ЧЕЛ'], file: 'Челябинская область.jpg', aliases: ['челябинская область', 'челябинск', 'чел', 'магнитка', 'магнитогорск', 'златоуст', 'миасс'] },
